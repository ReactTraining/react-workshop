...
//         return queuedMessages.concat(newMessage)
//       })
//     })
//   }
...
// Why? Why does this need to exist, it does nothing for me that's better??
...
//     async (prevMessages: Message[], formData: FormData) => {
//       console.log('START')
//       messageRef.current.value = ''
//       messageRef.current.focus()
