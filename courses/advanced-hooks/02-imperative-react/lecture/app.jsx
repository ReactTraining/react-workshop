...
export function App() {
  return (
    <p>
      Modern React is filled with . They work with function-components and they give us an ability
      to use state and other React features <Define>Hooks</Define> similarly to class-based
      components.
    </p>
  )
}
