...
//   const messageRef = useRef<HTMLInputElement>(null!)
//   const [messages, setMessages] = useState<Message[]>([])
//   const [pendingXX, startTransition] = useTransition()
...
//     // startTransition
//     async (current: ActionState, formData: FormData) => {
...
//   const [messages, action, pendingxxx] = useActionState(
//     async (currentMessages: Message[], formData: FormData) => {
//       messageRef.current.value = ''
//       messageRef.current.focus()
