...
//         return currentQueue.concat(newMessage)
//       })
//     })
//   }
...
//   const messageRef = useRef<HTMLInputElement>(null!)
//   const [messages, setMessages] = useState<Message[]>([])
//   const [x, startTransition] = useTransition()
...
// export function App() {
//   // comes with a built in startTransition
...
//   const [messages, action, pending] = useActionState(
//     async (currentState: Message[], formData: FormData) => {
//       console.log('START')
//       messageRef.current.value = ''
//       messageRef.current.focus()
...
//       return currentState.concat(newMessage)
//     },
//     []
//   )
