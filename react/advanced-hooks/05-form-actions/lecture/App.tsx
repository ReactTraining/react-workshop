...
//     messageRef.current.focus()
//     console.log('start')
//     const { message: newMessage } = await addMessage(formData.get('messageText') as string).then(
//       (res) => res.json()
//     )
//     setMessages((messages) => messages.concat(newMessage))
//     setPending(false)
...
// By convention, functions that uses async transitions are called “Actions”.
...
//             Submit
//           </button>
//           <Pending>Pending... from hook</Pending>
//         </div>
//       </form>
//       {messages.map((message) => (
//         <div key={message.id} className="border-b">
